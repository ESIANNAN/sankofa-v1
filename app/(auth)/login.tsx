...
export default function LoginScreen() {
  ...
  const handleBack = () => router.replace('/signup' as any);
  const handleForgotPassword = () => router.push('/forgot-password' as any);
  const handleGoogleSignIn = () => Alert.alert('Feature Unavailable', 'Google Sign-In is not configured yet.');
  const handleAppleSignIn = () => Alert.alert('Feature Unavailable', 'Apple Sign-In is not configured yet.');
